...
¬[value×reducible] (value-ṡuc p) (ξ-ṡuc q) = ¬[value×reducible] p q

¬[reducible×value] : {t s : Term} → t ⟶ s → ¬ Value t
¬[reducible×value] q p = ¬[value×reducible] p q
...
progress′ (⊢caseℕ̇ {Γ} {x} {t} {s} {r} typing₁ typing₂ typing₃) | inj₂ (t′ , p) = inj₂ (caseℕ̇ t′ [żero⇒ s |ṡuc x ⇒ r ] , ξ-caseℕ̇ p)
...
reindex ρ (⊢μ typing) = ⊢μ (reindex (extend ρ) typing)

typing₁ : ∅ , "f" ⦂ ℕ̇ ⇒ ℕ̇ ⊢ λ̇ "x" ⇒ "f"̇ · ("f"̇ · "x"̇) ⦂ ℕ̇ ⇒ ℕ̇
typing₁ = ⊢λ̇ (⊢· (⊢lookup (thereʳ here)) (⊢· (⊢lookup (thereʳ here)) (⊢lookup here)))

typing₂ : ∅ , "f" ⦂ ℕ̇ ⇒ ℕ̇ , "y" ⦂ ℕ̇ ⊢ λ̇ "x" ⇒ "f"̇ · ("f"̇ · "x"̇) ⦂ ℕ̇ ⇒ ℕ̇
...
perserve (⊢caseℕ̇ typing₁ typing₂ typing₃) (ξ-caseℕ̇ p) = ⊢caseℕ̇ (perserve typing₁ p) typing₂ typing₃
...
_ : eval (gas 13) ⊢2+2 ≡ steps
    (-- begin
            (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · ṡuc (ṡuc żero) · ṡuc (ṡuc żero)
        ⟶⟨ ξ-·₁ (ξ-·₁ β-μ) ⟩
            (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ])) · ṡuc (ṡuc żero) · ṡuc (ṡuc żero)
        ⟶⟨ ξ-·₁ (β-λ̇ (value-ṡuc (value-ṡuc value-żero))) ⟩
            (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ṡuc (ṡuc żero)
        ⟶⟨ β-λ̇ (value-ṡuc (value-ṡuc value-żero)) ⟩
            caseℕ̇ ṡuc (ṡuc żero) [żero⇒ ṡuc (ṡuc żero) |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · ṡuc (ṡuc żero)) ]
        ⟶⟨ β-ṡuc (value-ṡuc value-żero) ⟩
            ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · ṡuc żero · ṡuc (ṡuc żero))
        ⟶⟨ ξ-ṡuc (ξ-·₁ (ξ-·₁ β-μ)) ⟩
            ṡuc ((λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ])) · ṡuc żero · ṡuc (ṡuc żero))
        ⟶⟨ ξ-ṡuc (ξ-·₁ (β-λ̇ (value-ṡuc value-żero))) ⟩
            ṡuc ((λ̇ "m" ⇒ caseℕ̇ ṡuc żero [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ṡuc (ṡuc żero))
        ⟶⟨ ξ-ṡuc (β-λ̇ (value-ṡuc (value-ṡuc value-żero))) ⟩
            ṡuc caseℕ̇ ṡuc żero [żero⇒ ṡuc (ṡuc żero) |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · ṡuc (ṡuc żero)) ]
        ⟶⟨ ξ-ṡuc (β-ṡuc value-żero) ⟩
            ṡuc (ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · żero · ṡuc (ṡuc żero)))
        ⟶⟨ ξ-ṡuc (ξ-ṡuc (ξ-·₁ (ξ-·₁ β-μ))) ⟩
            ṡuc (ṡuc ((λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ])) · żero · ṡuc (ṡuc żero)))
        ⟶⟨ ξ-ṡuc (ξ-ṡuc (ξ-·₁ (β-λ̇ value-żero))) ⟩
            ṡuc (ṡuc ((λ̇ "m" ⇒ caseℕ̇ żero [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ṡuc (ṡuc żero)))
        ⟶⟨ ξ-ṡuc (ξ-ṡuc (β-λ̇ (value-ṡuc (value-ṡuc value-żero)))) ⟩
            ṡuc (ṡuc caseℕ̇ żero [żero⇒ ṡuc (ṡuc żero) |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · ṡuc (ṡuc żero)) ])
...
_ : eval (gas 37) ⊢2*2 ≡ steps
    (-- begin
            (μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · ṡuc (ṡuc żero) · ṡuc (ṡuc żero)
        ⟶⟨ ξ-·₁ (ξ-·₁ β-μ) ⟩
            (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ])) · ṡuc (ṡuc żero) · ṡuc (ṡuc żero)
        ⟶⟨ ξ-·₁ (β-λ̇ (value-ṡuc (value-ṡuc value-żero))) ⟩
            (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ṡuc (ṡuc żero)
        ⟶⟨ β-λ̇ (value-ṡuc (value-ṡuc value-żero)) ⟩
            caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · ṡuc (ṡuc żero) · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · ṡuc (ṡuc żero)) ]
        ⟶⟨ β-ṡuc (value-ṡuc value-żero) ⟩
            (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · ṡuc (ṡuc żero) · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · ṡuc żero · ṡuc (ṡuc żero))
        ⟶⟨ ξ-·₁ (ξ-·₁ β-μ) ⟩
            (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ])) · ṡuc (ṡuc żero) · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · ṡuc żero · ṡuc (ṡuc żero))
        ⟶⟨ ξ-·₁ (β-λ̇ (value-ṡuc (value-ṡuc value-żero))) ⟩
            (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · ṡuc żero · ṡuc (ṡuc żero))
        ⟶⟨ ξ-·₂ value-λ̇ (ξ-·₁ (ξ-·₁ β-μ)) ⟩
            (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ])) · ṡuc żero · ṡuc (ṡuc żero))
        ⟶⟨ ξ-·₂ value-λ̇ (ξ-·₁ (β-λ̇ (value-ṡuc value-żero))) ⟩
            (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((λ̇ "m" ⇒ caseℕ̇ ṡuc żero [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ṡuc (ṡuc żero))
        ⟶⟨ ξ-·₂ value-λ̇ (β-λ̇ (value-ṡuc (value-ṡuc value-żero))) ⟩
            (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · caseℕ̇ ṡuc żero [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · ṡuc (ṡuc żero) · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · ṡuc (ṡuc żero)) ]
        ⟶⟨ ξ-·₂ value-λ̇ (β-ṡuc value-żero) ⟩
            (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · ṡuc (ṡuc żero) · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · żero · ṡuc (ṡuc żero)))
        ⟶⟨ ξ-·₂ value-λ̇ (ξ-·₁ (ξ-·₁ β-μ)) ⟩
            (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ])) · ṡuc (ṡuc żero) · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · żero · ṡuc (ṡuc żero)))
        ⟶⟨ ξ-·₂ value-λ̇ (ξ-·₁ (β-λ̇ (value-ṡuc (value-ṡuc value-żero)))) ⟩
            (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · żero · ṡuc (ṡuc żero)))
        ...
        ⟶⟨ ξ-·₂ value-λ̇ (ξ-·₂ value-λ̇ (ξ-·₁ (β-λ̇ value-żero))) ⟩
            (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((λ̇ "m" ⇒ caseℕ̇ żero [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ṡuc (ṡuc żero)))
        ⟶⟨ ξ-·₂ value-λ̇ (ξ-·₂ value-λ̇ (β-λ̇ (value-ṡuc (value-ṡuc value-żero)))) ⟩
            (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · caseℕ̇ żero [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · ṡuc (ṡuc żero) · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · ṡuc (ṡuc żero)) ])
        ⟶⟨ ξ-·₂ value-λ̇ (ξ-·₂ value-λ̇ β-żero) ⟩
            (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · żero)
        ⟶⟨ ξ-·₂ value-λ̇ (β-λ̇ value-żero) ⟩
            (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · żero) ]
        ⟶⟨ ξ-·₂ value-λ̇ (β-ṡuc (value-ṡuc value-żero)) ⟩
            (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · ṡuc żero · żero)
        ⟶⟨ ξ-·₂ value-λ̇ (ξ-ṡuc (ξ-·₁ (ξ-·₁ β-μ))) ⟩
            (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ṡuc ((λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ])) · ṡuc żero · żero)
        ⟶⟨ ξ-·₂ value-λ̇ (ξ-ṡuc (ξ-·₁ (β-λ̇ (value-ṡuc value-żero)))) ⟩
            (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ṡuc ((λ̇ "m" ⇒ caseℕ̇ ṡuc żero [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · żero)
        ⟶⟨ ξ-·₂ value-λ̇ (ξ-ṡuc (β-λ̇ value-żero)) ⟩
            (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ṡuc caseℕ̇ ṡuc żero [żero⇒ żero |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · żero) ]
        ⟶⟨ ξ-·₂ value-λ̇ (ξ-ṡuc (β-ṡuc value-żero)) ⟩
            (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ṡuc (ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · żero · żero))
        ⟶⟨ ξ-·₂ value-λ̇ (ξ-ṡuc (ξ-ṡuc (ξ-·₁ (ξ-·₁ β-μ)))) ⟩
            (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ṡuc (ṡuc ((λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ])) · żero · żero))
        ⟶⟨ ξ-·₂ value-λ̇ (ξ-ṡuc (ξ-ṡuc (ξ-·₁ (β-λ̇ value-żero)))) ⟩
            (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ṡuc (ṡuc ((λ̇ "m" ⇒ caseℕ̇ żero [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · żero))
        ⟶⟨ ξ-·₂ value-λ̇ (ξ-ṡuc (ξ-ṡuc (β-λ̇ value-żero))) ⟩
            (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ṡuc (ṡuc caseℕ̇ żero [żero⇒ żero |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · żero) ])
...
--     (-- begin
--             (μ "^" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "m"̇ [żero⇒ ṡuc żero |ṡuc "m" ⇒ (μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · ("^"̇ · "n"̇ · "m"̇) ]))) · ṡuc (ṡuc żero) · ṡuc (ṡuc żero)
--         ⟶⟨ ξ-·₁ (ξ-·₁ β-μ) ⟩
--             (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "m"̇ [żero⇒ ṡuc żero |ṡuc "m" ⇒ (μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · ((μ "^" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "m"̇ [żero⇒ ṡuc żero |ṡuc "m" ⇒ (μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · ("^"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ])) · ṡuc (ṡuc żero) · ṡuc (ṡuc żero)
--         ⟶⟨ ξ-·₁ (β-λ̇ (value-ṡuc (value-ṡuc value-żero))) ⟩
--             (λ̇ "m" ⇒ caseℕ̇ "m"̇ [żero⇒ ṡuc żero |ṡuc "m" ⇒ (μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · ṡuc (ṡuc żero) · ((μ "^" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "m"̇ [żero⇒ ṡuc żero |ṡuc "m" ⇒ (μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · ("^"̇ · "n"̇ · "m"̇) ]))) · ṡuc (ṡuc żero) · "m"̇) ]) · ṡuc (ṡuc żero)
--         ⟶⟨ β-λ̇ (value-ṡuc (value-ṡuc value-żero)) ⟩
--             caseℕ̇ ṡuc (ṡuc żero) [żero⇒ ṡuc żero |ṡuc "m" ⇒ (μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · ṡuc (ṡuc żero) · ((μ "^" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "m"̇ [żero⇒ ṡuc żero |ṡuc "m" ⇒ (μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · ("^"̇ · "n"̇ · "m"̇) ]))) · ṡuc (ṡuc żero) · "m"̇) ]
--         ⟶⟨ β-ṡuc (value-ṡuc value-żero) ⟩
--             (μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · ṡuc (ṡuc żero) · ((μ "^" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "m"̇ [żero⇒ ṡuc żero |ṡuc "m" ⇒ (μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · ("^"̇ · "n"̇ · "m"̇) ]))) · ṡuc (ṡuc żero) · ṡuc żero)
--         ⟶⟨ ξ-·₁ (ξ-·₁ β-μ) ⟩
--             (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ])) · ṡuc (ṡuc żero) · ((μ "^" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "m"̇ [żero⇒ ṡuc żero |ṡuc "m" ⇒ (μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · ("^"̇ · "n"̇ · "m"̇) ]))) · ṡuc (ṡuc żero) · ṡuc żero)
--         ⟶⟨ ξ-·₁ (β-λ̇ (value-ṡuc (value-ṡuc value-żero))) ⟩
--             (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((μ "^" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "m"̇ [żero⇒ ṡuc żero |ṡuc "m" ⇒ (μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · ("^"̇ · "n"̇ · "m"̇) ]))) · ṡuc (ṡuc żero) · ṡuc żero)
--         ⟶⟨ ξ-·₂ value-λ̇ (ξ-·₁ (ξ-·₁ β-μ)) ⟩
...
--         ⟶⟨ ξ-·₂ value-λ̇ (β-λ̇ (value-ṡuc value-żero)) ⟩
--             (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · caseℕ̇ ṡuc żero [żero⇒ ṡuc żero |ṡuc "m" ⇒ (μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · ṡuc (ṡuc żero) · ((μ "^" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "m"̇ [żero⇒ ṡuc żero |ṡuc "m" ⇒ (μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · ("^"̇ · "n"̇ · "m"̇) ]))) · ṡuc (ṡuc żero) · "m"̇) ]
--         ⟶⟨ ξ-·₂ value-λ̇ (β-ṡuc value-żero) ⟩
--             (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · ṡuc (ṡuc żero) · ((μ "^" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "m"̇ [żero⇒ ṡuc żero |ṡuc "m" ⇒ (μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · ("^"̇ · "n"̇ · "m"̇) ]))) · ṡuc (ṡuc żero) · żero))
--         ⟶⟨ ξ-·₂ value-λ̇ (ξ-·₁ (ξ-·₁ β-μ)) ⟩
--             (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ])) · ṡuc (ṡuc żero) · ((μ "^" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "m"̇ [żero⇒ ṡuc żero |ṡuc "m" ⇒ (μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · ("^"̇ · "n"̇ · "m"̇) ]))) · ṡuc (ṡuc żero) · żero))
--         ⟶⟨ ξ-·₂ value-λ̇ (ξ-·₁ (β-λ̇ (value-ṡuc (value-ṡuc value-żero)))) ⟩
--             (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((μ "^" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "m"̇ [żero⇒ ṡuc żero |ṡuc "m" ⇒ (μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · ("^"̇ · "n"̇ · "m"̇) ]))) · ṡuc (ṡuc żero) · żero))
--         ⟶⟨ ξ-·₂ value-λ̇ (ξ-·₂ value-λ̇ (ξ-·₁ (ξ-·₁ β-μ))) ⟩
...
--         ⟶⟨ ξ-·₂ value-λ̇ (ξ-·₂ value-λ̇ (β-λ̇ value-żero)) ⟩
--             (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · caseℕ̇ żero [żero⇒ ṡuc żero |ṡuc "m" ⇒ (μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · ṡuc (ṡuc żero) · ((μ "^" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "m"̇ [żero⇒ ṡuc żero |ṡuc "m" ⇒ (μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · ("^"̇ · "n"̇ · "m"̇) ]))) · ṡuc (ṡuc żero) · "m"̇) ])
--         ⟶⟨ ξ-·₂ value-λ̇ (ξ-·₂ value-λ̇ β-żero) ⟩
--             (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ṡuc żero)
--         ⟶⟨ ξ-·₂ value-λ̇ (β-λ̇ (value-ṡuc value-żero)) ⟩
--             (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · ṡuc żero · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · ṡuc żero) ]
--         ⟶⟨ ξ-·₂ value-λ̇ (β-ṡuc (value-ṡuc value-żero)) ⟩
--             (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · ṡuc żero · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · ṡuc żero · ṡuc żero))
--         ⟶⟨ ξ-·₂ value-λ̇ (ξ-·₁ (ξ-·₁ β-μ)) ⟩
--             (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ])) · ṡuc żero · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · ṡuc żero · ṡuc żero))
--         ⟶⟨ ξ-·₂ value-λ̇ (ξ-·₁ (β-λ̇ (value-ṡuc value-żero))) ⟩
--             (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((λ̇ "m" ⇒ caseℕ̇ ṡuc żero [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · ṡuc żero · ṡuc żero))
--         ⟶⟨ ξ-·₂ value-λ̇ (ξ-·₂ value-λ̇ (ξ-·₁ (ξ-·₁ β-μ))) ⟩
...
--             (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((λ̇ "m" ⇒ caseℕ̇ ṡuc żero [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ])) · ṡuc żero · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · żero · ṡuc żero)))
--         ⟶⟨ ξ-·₂ value-λ̇ (ξ-·₂ value-λ̇ (ξ-·₁ (β-λ̇ (value-ṡuc value-żero)))) ⟩
--             (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((λ̇ "m" ⇒ caseℕ̇ ṡuc żero [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((λ̇ "m" ⇒ caseℕ̇ ṡuc żero [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · żero · ṡuc żero)))
...
--         ⟶⟨ ξ-·₂ value-λ̇ (ξ-·₂ value-λ̇ (β-λ̇ value-żero)) ⟩
--             (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((λ̇ "m" ⇒ caseℕ̇ ṡuc żero [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · caseℕ̇ ṡuc żero [żero⇒ żero |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · żero) ])
--         ⟶⟨ ξ-·₂ value-λ̇ (ξ-·₂ value-λ̇ (β-ṡuc value-żero)) ⟩
--             (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((λ̇ "m" ⇒ caseℕ̇ ṡuc żero [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · żero · żero))
...
--             (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((λ̇ "m" ⇒ caseℕ̇ ṡuc żero [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ṡuc ((λ̇ "m" ⇒ caseℕ̇ żero [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · żero))
--         ⟶⟨ ξ-·₂ value-λ̇ (ξ-·₂ value-λ̇ (ξ-ṡuc (β-λ̇ value-żero))) ⟩
--             (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((λ̇ "m" ⇒ caseℕ̇ ṡuc żero [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ṡuc caseℕ̇ żero [żero⇒ żero |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · żero) ])
--         ⟶⟨ ξ-·₂ value-λ̇ (ξ-·₂ value-λ̇ (ξ-ṡuc β-żero)) ⟩
--             (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ((λ̇ "m" ⇒ caseℕ̇ ṡuc żero [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ṡuc żero)
--         ⟶⟨ ξ-·₂ value-λ̇ (β-λ̇ (value-ṡuc value-żero)) ⟩
--             (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · caseℕ̇ ṡuc żero [żero⇒ ṡuc żero |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · ṡuc żero) ]
--         ⟶⟨ ξ-·₂ value-λ̇ (β-ṡuc value-żero) ⟩
--             (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · żero · ṡuc żero)
--         ⟶⟨ ξ-·₂ value-λ̇ (ξ-ṡuc (ξ-·₁ (ξ-·₁ β-μ))) ⟩
--             (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ṡuc ((λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ])) · żero · ṡuc żero)
--         ⟶⟨ ξ-·₂ value-λ̇ (ξ-ṡuc (ξ-·₁ (β-λ̇ value-żero))) ⟩
--             (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ṡuc ((λ̇ "m" ⇒ caseℕ̇ żero [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ṡuc żero)
--         ⟶⟨ ξ-·₂ value-λ̇ (ξ-ṡuc (β-λ̇ (value-ṡuc value-żero))) ⟩
--             (λ̇ "m" ⇒ caseℕ̇ ṡuc (ṡuc żero) [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ((μ "*" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ żero |ṡuc "n" ⇒ (μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "m"̇ · ("*"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · "m"̇) ]) · ṡuc caseℕ̇ żero [żero⇒ ṡuc żero |ṡuc "n" ⇒ ṡuc ((μ "+" ⇒ (λ̇ "n" ⇒ (λ̇ "m" ⇒ caseℕ̇ "n"̇ [żero⇒ "m"̇ |ṡuc "n" ⇒ ṡuc ("+"̇ · "n"̇ · "m"̇) ]))) · "n"̇ · ṡuc żero) ]
...
determinism (β-λ̇ value₁) (ξ-·₂ value₂ q) = ⊥-elim (¬[value×reducible] value₁ q)
determinism β-żero β-żero = refl
determinism (β-ṡuc value₁) (β-ṡuc value₂) = refl
determinism (β-ṡuc value₁) (ξ-caseℕ̇ q) = ⊥-elim (¬[value×reducible] (value-ṡuc value₁) q)
determinism β-μ β-μ = refl
determinism (ξ-·₁ {s = s} p) (ξ-·₁ q) = cong (_· s) (determinism p q)
determinism (ξ-·₁ p) (ξ-·₂ value₂ q) = ⊥-elim (¬[value×reducible] value₂ p)
determinism (ξ-·₂ value₁ p) (β-λ̇ value₂) = ⊥-elim (¬[value×reducible] value₂ p)
determinism (ξ-·₂ value₁ p) (ξ-·₁ q) = ⊥-elim (¬[value×reducible] value₁ q)
determinism (ξ-·₂ {t = t} value₁ p) (ξ-·₂ value₂ q) = cong (t ·_) (determinism p q)
determinism (ξ-caseℕ̇ p) (β-ṡuc value₂) = ⊥-elim (¬[value×reducible] (value-ṡuc value₂) p)
determinism (ξ-ṡuc p) (ξ-ṡuc q) = cong ṡuc_ (determinism p q)
determinism (ξ-caseℕ̇ {x = x} {s = s} {r = r} p) (ξ-caseℕ̇ q) = cong caseℕ̇_[żero⇒ s |ṡuc x ⇒ r ] (determinism p q)
